...
class MobileAssignmentService:
    ...
    def _build_site(self, site: Site) -> MobileSite:
        ...
        return MobileSite(
            ...
            street=getattr(site, "street", None),
            house_number=getattr(site, "house_number", None),
            postal_code=getattr(site, "postal_code", None),
            city=getattr(site, "city", None),
            address_extra=getattr(site, "address_extra", None),
